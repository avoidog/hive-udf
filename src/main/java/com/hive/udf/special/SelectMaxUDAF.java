...
public class SelectMaxUDAF extends AbstractGenericUDAFResolver {
  ...
  public GenericUDAFEvaluator getEvaluator(TypeInfo[] parameters)
    ...
    return new SelectMaxEvaluator();
  }

  public static class SelectMaxEvaluator extends GenericUDAFEvaluator {
    ...
    private void compare(MinAgg myagg, Object key, Object val){
        int r = ObjectInspectorUtils.compare(key, inputOI, myagg.o, inputOI);
        if (myagg.o == null || r > 0) {
