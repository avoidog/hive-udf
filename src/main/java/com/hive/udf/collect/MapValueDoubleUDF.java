...
public class MapValueDoubleUDF extends GenericUDF {
    ...
    public Object evaluate(DeferredObject[] arg0) throws HiveException {
        ...
        for (Object hiveKey : hiveMap.keySet()){
                ...
                if (valStd instanceof String && !((String)valStd).equalsIgnoreCase("null"))
                    retVal.put(keyStd, Double.parseDouble((String)valStd));
                if (valStd instanceof Text && !((Text)valStd).toString().equalsIgnoreCase("null"))
                    retVal.put(keyStd, Double.parseDouble(((Text)valStd).toString()));
        }
        return retVal;
    }
